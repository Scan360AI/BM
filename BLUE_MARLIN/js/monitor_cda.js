 ...
 const chartData = {
     trendRicaviEbitda: {
         ...
         datasets: [
             {
                 label: "Ricavi (€)",
                 data: [1263072, 1227410, 1223477], // Valori Blue Marlin
             ...
             {
                 label: "EBITDA (€)",
                 data: [92687, 52926, 223543], // Valori Blue Marlin
              ...
              {
                  label: "EBITDA Margin (%)",
                  data: [7.3, 4.3, 18.3], // Valori Blue Marlin
     ...
     trendPfnEbitda: {
         ...
         datasets: [
             {
                 label: "PFN/EBITDA",
                 data: [12.48, 19.94, 5.11], // Valori Blue Marlin
              ...
              {
                 label: 'Soglia Critica (>4x)', // Soglia più alta dato il valore
                 data: [4, 4, 4], // Linea target critica
     ...
     trendWorkingCapital: {
        labels: ['2022', '2023', '2024'],
         datasets: [
            { label: 'DSO', data: [98, 85, 120], borderColor: '#4CAF50', backgroundColor: 'rgba(76, 175, 80, 0.2)', fill: false, tension: 0.1 },
            { label: 'DIO', data: [194, 225, 292], borderColor: '#FFC107', backgroundColor: 'rgba(255, 193, 7, 0.2)', fill: false, tension: 0.1 },
            { label: 'DPO', data: [94, 103, 130], borderColor: '#4a69bd', backgroundColor: 'rgba(74, 105, 189, 0.2)', fill: false, tension: 0.1 },
            { label: 'Ciclo Circolante', data: [198, 207, 282], borderColor: '#F44336', backgroundColor: 'rgba(244, 67, 54, 0.2)', fill: true, tension: 0.1, borderWidth: 2 }
         ]
     },
    trendCashFlowOp: {
        labels: ['2022', '2023', '2024'],
        datasets: [{
            ...
            data: [-7.07, 7.64, -6.99], // Valori Blue Marlin
            borderColor: 'rgb(77, 140, 87)',
 ...
 const trendRicEbitdaOptionsCda = {
     ...
     scales: {
         ...
         y1: { // Asse secondario (destra) per Percentuale
             ...
             suggestedMin: 0,
             suggestedMax: 20, // Adattato per Blue Marlin
             ticks: {
 ...
 const trendPfnEbitdaOptionsCda = {
     ...
     scales: {
         y: { // Scala per il rapporto
             ...
             suggestedMin: 0,
             suggestedMax: 25, // Aumentato per Blue Marlin
...
const trendWorkingCapitalOptionsCda = {
     ...
     scales: {
         y: {
             ...
             suggestedMax: 300 // Aumentato per Blue Marlin
         },
          x: { grid: { display: false } }
     },
     plugins: {
...
document.addEventListener('DOMContentLoaded', function() {
     console.log("Initializing CDA charts for Blue Marlin S.R.L.");
...
// ======================================
 document.addEventListener('DOMContentLoaded', function() {
     ...
     const irpScoreValue = 56.32; // Valore IRP Blue Marlin
